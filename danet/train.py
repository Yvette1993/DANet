...
class Trainer():
    def __init__(self, args):
        ...
        self.valloader = torch.utils.data.DataLoader(testset, batch_size=args.batch_size,
        ...
        if args.cuda:
            ...
            self.model = self.model.cuda()     ####liyingying----->
            self.criterion = self.criterion.cuda()    ####--->2020/01/17
